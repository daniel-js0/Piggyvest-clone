    ...
    <nav className={`z-10 fixed top-0 flex flex-row justify-between gap-14 h-20 w-screen 
        ...
        <div className='flex flex-row justify-start gap-14 ml-5 md:ml-[2%] xl:ml-[8%]'>
              ...
              <div className='lg:flex flex-row  justify-evenly gap-6 mt-10 hidden'>
                  <Link href="/" onMouseEnter={handleHover} onMouseLeave={handleHover2}><h2 className={` font-semibold ${!scroll ? 'text-rose-500' : 'text-gray-600'}`} >Save</h2></Link>
        ...
        {save && (<div className=' absolute top-14 start-[21%] shadow-2xl w-[34%] bg-white h-60 rounded-2xl grid grid-cols-2'>
                <div className='flex mt-5 ml-8'>
                    <img className='h-10 w-10 mt-1' src="https://storage.googleapis.com/new-abeg-avatar-dev/piggyvest-cms-staging/piggybank_icon_bd14f39497/piggybank_icon_bd14f39497.png" width="25"/>
                ...
                <div className='flex mt-5 ml-2'>
                    <img className='h-10 w-10 mt-1' src="https://storage.googleapis.com/new-abeg-avatar-dev/piggyvest-cms-staging/safelock_icon_7595628576/safelock_icon_7595628576.png" width="25"/> 
                    <div className='ml-1.5'>
                ...
                <div className='flex ml-8'>
                    <img className='h-10 w-10 mt-1'src="https://storage.googleapis.com/new-abeg-avatar-dev/piggyvest-cms-staging/targets_icon_a382a2df4f/targets_icon_a382a2df4f.png" width="25"></img>  
                    <div className='ml-1.5'>
                ...
                <div className='flex'>
                    <img className='h-10 w-10 mt-1 ml-2' src="https://storage.googleapis.com/new-abeg-avatar-dev/piggyvest-cms-staging/flex_naira_icon_1c37272848/flex_naira_icon_1c37272848.png" width="25"></img>
                    <div className='ml-1.5'>
                ...
                <div className='flex ml-8'>
                    <img className='h-10 w-10 mt-1' src="https://storage.googleapis.com/new-abeg-avatar-dev/piggyvest-cms-staging/flex_dollar_icon_b180813700/flex_dollar_icon_b180813700.png" width="25"></img>
                    <div className='ml-1.5'>
        ...
        {resource && (<div className=' absolute top-14 start-[41%] shadow-2xl w-[34%] bg-white h-60 rounded-2xl grid grid-cols-2'>
                ...
                <div className='flex'>
                    ...
                    <div className='ml-1.5'>
                      <h3 className='mt-2 text-gray-900'>Newsletter</h3>
                    </div>
                </div>
                ...
                <div className='flex ml-8'>
                    ...
                    <div className='ml-1.5'>
                      <h3 className='mt-2 text-gray-900'>Ebook</h3>
                    </div>
                </div>
        </div>)}
