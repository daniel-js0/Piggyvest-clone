    ...
    <nav className={`z-10 fixed top-0 flex flex-row justify-between gap-14 h-20 w-screen 
        ...
        <div className='flex flex-row justify-start gap-14 ml-5 md:ml-[2%] xl:ml-[8%]'>
              <Link href="/">
                ...
                ? (<img className='h-20 w-40 md:h-24 md:w-44' src="https://storage.googleapis.com/new-abeg-avatar-dev/piggyvest-cms-staging/white_logo_c3427147fd/white_logo_c3427147fd.svg" alt="PiggyVest Logo" width="225" height="40"></img>)

                : (<img className=' h-20 w-40 md:h-24 md:w-44' src="https://storage.googleapis.com/piggyvestwebsite/piggywebsite2020/investify_logo_1d7ed8f562/investify_logo_1d7ed8f562.svg" alt="PiggyVest Logo" width="225" height="40"></img>)}
              ...
              <div className='lg:flex flex-row  justify-evenly gap-6 mt-10 hidden'>
                  ...
                  <Link href="/"><h2 className={`font-semibold ${invScroll ? 'text-gray-600': 'text-gray-50'}`}  >Stories</h2></Link>
