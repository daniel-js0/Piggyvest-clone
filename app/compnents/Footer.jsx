    ...
    return (
      <footer className="mx-auto bg-gray-50 ">
         ...
         <div className="mt-7 grid grid-cols-1  min-[374px]:grid-cols-2 sm:grid-cols-3 lg:flex lg:justify-around md:gap-4 md:w-[80%] md:mx-auto">
            ...
            <Image width={360} height={100} quality={100} className='h-10 w-36 ml-7 lg:ml-0   max-[373px]:mx-auto' src="https://storage.googleapis.com/piggyvestwebsite/piggywebsite2020/brand3_972c03908c/brand3_972c03908c.png" alt="brand"/></a>
           
            <a href="https://guardian.ng/news/nigeria/piggybank-asserts-expansion-plans-becomes-piggyvest/" target="_blank" rel="noreferrer" >
            <Image width={440} height={80} quality={100} className="h-8 w-44 -ml-1 lg:ml-0   max-[373px]:mx-auto max-[373px]:mt-6" src="https://storage.googleapis.com/piggyvestwebsite/piggywebsite2020/brand2_3fcc7de2d6/brand2_3fcc7de2d6.png" alt="brand"/></a>
            ...
            <Image width={440} height={80} quality={100}className="h-8 w-44 mt-4 sm:mt-0 ml-8 lg:ml-0 lg:mt-0  max-[373px]:mx-auto max-[373px]:mt-6" src="https://storage.googleapis.com/piggyvestwebsite/piggywebsite2020/brand1_b2a9805fff/brand1_b2a9805fff.png" alt="brand"/></a>
            ...
            <Image width={100} height={80} quality={100} className="mt-3 ml-12 lg:ml-0 md:mt-6 lg:mt-0         max-[373px]:mx-auto max-[373px]:mt-4" src="https://storage.googleapis.com/piggyvestwebsite/piggywebsite2020/pym_removebg_preview_109a666426/pym_removebg_preview_109a666426.svg" alt="brand"/></a>
                
            <a href="https://www.fastcompany.com/90457936/africa-most-innovative-companies-2020" target="_blank" rel="noreferrer" >
            <Image width={100} height={80} quality={100}className=" mt-4 ml-12 lg:ml-0 md:mt-4 lg:-mt-3       max-[373px]:mx-auto max-[373px]:-mt-1" src="https://storage.googleapis.com/piggyvestwebsite/piggywebsite2020/fast_61fdc50524/fast_61fdc50524.svg" alt="brand"/></a>
            ...
            <Image width={80} height={50} quality={100} className="mt-6 ml-14 lg:ml-0 md:mt-6 lg:mt-0       max-[373px]:mx-auto max-[373px]:-mt-1" src="https://storage.googleapis.com/piggyvestwebsite/piggywebsite2020/cio_6806ee3afd/cio_6806ee3afd.svg" alt="brand"/></a>
        </div>
