    ...
    return (
      <footer className="mx-auto">
         ...
         <div className="mt-7 grid grid-cols-1  min-[374px]:grid-cols-2 sm:grid-cols-3 lg:flex lg:justify-around md:gap-4 md:w-[80%] md:mx-auto">
          ...
          <div className="mt-12 flex w-[83%] mx-auto ">
            <div className="">
                <Link href="/">
                    <svg width="192" height="37" viewBox="0 0 192 37" fill="none" xmlns="http://www.w3.org/2000/svg"
                      className='h-20 w-40 md:h-24 md:w-44 ml-5 md:ml-[2%] xl:ml-[8%]'>
                ...
                <Image
                 src={Logo} 
                 className="ml-5 md:ml-[2%] xl:ml-[10%] h-24"
                 alt="NDPR audit" 
                 width={110} 
                 quality={100}
                 placeholder='blur' 
            ...
            <div className="sm:flex sm:justify-between  w-[40%] mx-auto">
                 <div className="flex justify-between gap-28">
                    <div>
                      <p className="font-bold">Products</p>
                      <p className="text-gray-500 mt-2">Piggybank</p>
                      <p className="text-gray-500 mt-2">Invest</p>
                      <p className="text-gray-500 mt-2">Safelock</p>
                      <p className="text-gray-500 mt-2">Target Savings</p>
                      <p className="text-gray-500 mt-2">Flex Naira</p>
                      <p className="text-gray-500 mt-2">Flex Dollar</p>
                    </div>
                    <div className="">
                      <p className="font-bold">Company</p>
                      <Link href="/"><p className="text-gray-500 mt-2">About</p></Link>
                      <p className="text-gray-500 mt-2">FAQs</p>
                      <p className="text-gray-500 mt-2">Blog</p>
                    </div>
                    <div className="md:flex md:flex-col hidden">
                      <p className="font-bold">Legal</p>
                      <p className="text-gray-500 mt-2">Terms</p>
                      <p className="text-gray-500 mt-2">Privacy</p>
                      <p className="text-gray-500 mt-2">Security</p>
                    </div>
                 </div>
            ...
            <div className="w-[30%]  bg-slate-900 h-36">
                <div className="flex justify-between w-[50%] h-5 bg-slate-300 ms-auto">
               ...
               <div className="mt-3 w-[90] h-24 bg-slate-500 flex flex-col ">
                  <p className=" ms-auto">Tesmot house, Abdulrahman Okene close,</p>
                  <p className=" ms-auto">Victoria Island, Lagos, Nigeria.</p>
                  <p className=" ms-auto">contact@piggyvest.com</p>
                  <p className=" ms-auto">+234 700 933 933 933</p>
               </div>
